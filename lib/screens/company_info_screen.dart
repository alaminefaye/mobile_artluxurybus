      ...
      child: Column(
        ...
        children: [
          ...
          _buildAgencyCard(
            context,
            title: 'Gare d\'Adjamé',
            location: '220 Logements, en face Marie Thérèse',
            subtitle: 'Adjamé - Abidjan, Côte d\'Ivoire',
          ),
          const SizedBox(height: 12),
          _buildAgencyCard(
            context,
            title: 'Gare de Yopougon',
            location: 'Bel Air, juste en face d\'Ecobank',
            subtitle: 'Yopougon - Abidjan, Côte d\'Ivoire',
          ),
          const SizedBox(height: 12),
          _buildAgencyCard(
            context,
            title: 'Gare de Bouaké',
            location: 'Quartier Commerce, en face de l\'agence Orange',
            subtitle: 'Bouaké, Côte d\'Ivoire - Ouvert 24h/24',
          ),
          const SizedBox(height: 12),
          _buildAgencyCard(
            context,
            title: 'Gare de Yamoussoukro',
            location: 'Carrefour de la clinique le Walê, non loin de la pharmacie Fatima',
            subtitle: 'Yamoussoukro, Côte d\'Ivoire',
          ),
        ],
      ),
    );
